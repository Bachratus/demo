...
import com.bachratus.demo.infra.web.controller.CustomerController;
...
class CreateCustomerAccountControllerTest {
    ...
    @Test
    void shouldCreateCustomerUsingDisplayNameFromBodyAndSubjectFromJwt()
            throws Exception {
        ...
        ArgumentCaptor<CreateCustomerAccountRequest> captor =
                ArgumentCaptor.forClass(
                        CreateCustomerAccountRequest.class
                );
        ...
        assertThat(captor.getValue())
                .isEqualTo(new CreateCustomerAccountRequest(
                        DISPLAY_NAME,
                        JWT_SUBJECT
                ));
    }
    ...
    private Customer createCustomerFixture() {
        return Customer.builder()
                ...
                .displayName(
                        CustomerDisplayName.required(DISPLAY_NAME)
                )
                .build();
    }
}